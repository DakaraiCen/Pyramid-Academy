...
public class Main {
   ...
   /* public void Construct (){
    ...
    public void setBoardingInfo() {
        ...
        pass.setPassportNumber((int) (Math.random() * (250 - 100) + 100));
    }
    ...
    public void generateTicket() throws IOException {
        ...
        ticketFilename = String.format("%s_%s.txt", pass.getPassportNumber(), human.getName().toUpperCase());

        PrintWriter writer = new PrintWriter(new FileWriter(ticketFilename));

        writer.println("=============================================================");
        writer.printf("%20s%3s %s\n", "Boarding Pass Number", ":", pass.getPassportNumber());
